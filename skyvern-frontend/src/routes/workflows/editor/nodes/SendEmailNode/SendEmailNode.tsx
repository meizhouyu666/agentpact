      ...
      >
        ...
        <div className="space-y-2">
          <div className="flex justify-between">
            <Label className="text-xs" style={{ color: "var(--finrpa-text-secondary)" }}>Recipients</Label>
        ...
        <Separator />
        <div className="space-y-2">
          <Label className="text-xs" style={{ color: "var(--finrpa-text-secondary)" }}>Subject</Label>
          <WorkflowBlockInput
            nodeId={id}
            onChange={(value) => {
        ...
        <div className="space-y-2">
          <Label className="text-xs" style={{ color: "var(--finrpa-text-secondary)" }}>Body</Label>
        ...
        <div className="space-y-2">
          <div className="flex gap-2">
            <Label className="text-xs" style={{ color: "var(--finrpa-text-secondary)" }}>File Attachments</Label>
            <HelpTooltip
