        ...
        >
          ...
          <div className="space-y-2">
            <div className="flex justify-between">
              <Label className="text-xs" style={{ color: "var(--finrpa-text-secondary)" }}>Complete if...</Label>
          ...
          <div className="space-y-2">
            <Label className="text-xs" style={{ color: "var(--finrpa-text-secondary)" }}>Terminate if...</Label>
            <WorkflowBlockInputTextarea
