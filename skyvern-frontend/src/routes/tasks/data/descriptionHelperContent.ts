...
export const navigationPayloadDescription =
  "The user's details needed to achieve the task. This is an unstructured field, and information can be passed in in any format you desire. FinRPA will map this information to the questions on the screen in real-time.";

export const extractedInformationSchemaDescription =
  "(Optional) The requested schema of the extracted information for data extraction goal. This is a JSON object with keys as the field names and values as the data types. The data types can be any of the following: string, number, boolean, date, datetime, time, float, integer, object, array, null. If the schema is not provided, FinRPA will infer the schema from the extracted data.";
